...
from prepare_datas import dataloaders
...
def train_epoch(feature_model, epoch, model, data_loader, optimizer, optimizer2, alpha):
    ...
    for idx,(batch_data,batch_target,posi_data,nega_data,cluster_weight,class_prototype) in enumerate(data_loader):
        ...
        nega_loss=nega_loss_calcu(batch_features,nega_features,config.sample_k)
