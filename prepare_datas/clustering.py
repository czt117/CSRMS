...
def art(M, label, rho, beta):
    ...
    return Wv, L, J, rho, Assign



path_data_train = './feats/vireo/feat.txt'
path_label_train = './feats/vireo/label.txt'

# path_data_test = './feats/cifar10_feats_test_resnet18.npy'
# path_label_test = './feats/cifar10_labels_test_resnet18.npy'
...
# hidden_vector_scaled_test = np.load(path_data[1])
# hidden_vector_classIDs_test = np.load(path_labels[1])
...
cluster_path = './cluster_results/art/vireo/' + str(rho) +'/'
